...
function openModal(modalId) {
    ...
    if (modalId === 'manageEventsModal' && currentUser === 'GDGADMIN') {
        loadEvents();
        loadAdmins();
    }
}
...
function deleteAdmin(id, username) {
    if (username === 'GDGADMIN') {
        alert("GDGADMIN is a system account and cannot be deleted.");
        return;
    }
